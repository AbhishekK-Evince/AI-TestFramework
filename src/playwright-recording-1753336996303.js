...
test('test', async ({ page }) => {
  ...
  await page.evaluate(() => window.scrollBy(0, 200)); // Auto-recorded scroll
  await page.evaluate(() => window.scrollBy(0, -200)); // Auto-recorded scroll
  await page.locator(`div:nth-of-type(3).accordion-item > div.accordion-collapse > div.accordion-body > div:nth-of-type(1)`).click();
  ...
  await page.evaluate(() => window.scrollBy(0, -1300)); // Auto-recorded scroll
  await page.evaluate(() => window.scrollBy(0, -400)); // Auto-recorded scroll
  await page.evaluate(() => window.scrollBy(0, -200)); // Auto-recorded scroll
});